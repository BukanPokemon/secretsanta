...
export function Settings({
  ...
  const updateField = <K extends keyof EventMetadata>(
    key: K,
    value: EventMetadata[K],
  ) => {
      ...
      <div className="p-4 bg-gray-50 rounded-lg space-y-4">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              updateField('eventName', e.target.value || undefined)
            }
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('eventDate', e.target.value || undefined)
              }
              className="w-full p-2 border rounded"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateField('exchangeDeadline', e.target.value || undefined)
              }
              className="w-full p-2 border rounded"
            />
          </div>
        ...
        <div>
          ...
          <div className="mt-2 flex flex-wrap gap-1.5">
            {BUDGET_PRESETS[i18n.language === 'id' ? 'IDR' : 'USD'].map(
              (preset) => (
                <button
                ...
                >
                  {formatBudget(preset.min, i18n.language)}–
                  {formatBudget(preset.max, i18n.language)}
                </button>
              ),
            )}
          </div>
